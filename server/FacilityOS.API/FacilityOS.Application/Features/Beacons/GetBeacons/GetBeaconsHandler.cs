...
public class GetBeaconsHandler : IRequestHandler<GetBeaconsQuery, PagedResult<BeaconResponse>>
{
    ...
    public GetBeaconsHandler(IApplicationDbContext context, ICurrentUserService currentUser)
    {
        _context = context;
    ...
    private IQueryable<Beacon> ApplyAccessFilter(IQueryable<Beacon> query)
    {
